    ...
    >
      ...
      <div className="col-span-4 h-full">
        <button
          ...
          className="glass-card flex h-full min-h-[180px] w-full cursor-pointer flex-col items-center justify-center gap-4 p-6 text-left"
        >
          ...
          <div className="text-center">
            ...
            <p className="mt-0.5 text-sm text-[#94a3b8]">Portfolio overview</p>
          </div>
        </button>
      </div>
      <div className="col-span-4 h-full">
              ...
              {PORTFOLIO_STOCKS.map((s) => (
                ...
                >
                  <div>
                    ...
                    <p className="text-xs text-[#94a3b8]">Units {s.units}</p>
                  </div>
          ...
          >
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="text-center">
                ...
                <p className="mt-1 text-sm text-[#94a3b8]">rachel@gmail.com</p>
